...
- create own SQLite database and store the data about the POIs. Think about what will be the best structure of the database. We've created sqlite3 databases before in the activity [**Pandas with SQL**](/71d9e264-4939-4906-9ef1-725c0ff270a0).
